                    ...
                    <form action="{{ route("student.update",$student->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control rounded" value="{{ old("admission_form_no",$student->admission_form_no) }}" name="admission_form_no" placeholder="Enter Admission Form No">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="date" class="form-control rounded" value="{{ old("admission_date",$student->admission_date) }}" name="admission_date" placeholder="Enter Last Name">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control rounded" value="{{ old("registration_no",$student->registration_no) }}" name="registration_no" placeholder="Registration No">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control rounded" value="{{ old("roll",$student->roll) }}" name="roll" placeholder="Roll">
                                @error('roll')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control rounded" value="{{ old("nid_no",$student->nid_no) }}" name="nid_no" placeholder=" NID OR BIRTH NO">
                                @error('nid_no')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" name="father_nid" value="{{ old("father_nid",$student->father_nid) }}" class="form-control rounded" id="" placeholder="Father NID">
                                @error('father_nid')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" name="mother_nid" value="{{ old("mother_nid",$student->mother_nid) }}" class="form-control rounded" id="" placeholder="Mother  Occupation">
                                @error('mother_nid')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
