        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <h6 class="card-header bg-primary text-white">
                    ...
                    <a href="{{ url("/teacher/status/change",$teacher->id) }}" class="badge badge-success">Active</a>
                  @else
                    <a href="{{ url("/teacher/status/change",$teacher->id) }}" class="badge badge-danger">Inactive</a>
                  @endif )
